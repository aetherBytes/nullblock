...
DATABASE_URL=postgresql://nullblock:nullblock_secure_pass@localhost:5432/nullblock
MCP_DATABASE_URL=postgresql://nullblock:nullblock_secure_pass@localhost:5432/nullblock_mcp
ORCHESTRATION_DATABASE_URL=postgresql://nullblock:nullblock_secure_pass@localhost:5432/nullblock_orchestration
AGENTS_DATABASE_URL=postgresql://nullblock:nullblock_secure_pass@localhost:5432/nullblock_agents
EREBUS_DATABASE_URL=postgresql://nullblock:nullblock_secure_pass@localhost:5432/nullblock_erebus
HECATE_DATABASE_URL=postgresql://nullblock:nullblock_secure_pass@localhost:5432/nullblock_hecate
PLATFORM_DATABASE_URL=postgresql://nullblock:nullblock_secure_pass@localhost:5432/nullblock_platform
