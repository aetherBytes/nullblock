...
MCP_DATABASE_URL=postgresql://postgres:postgres_secure_pass@localhost:5442/mcp
ORCHESTRATION_DATABASE_URL=postgresql://postgres:postgres_secure_pass@localhost:5443/orchestration
AGENTS_DATABASE_URL=postgresql://postgres:postgres_secure_pass@localhost:5441/agents
EREBUS_DATABASE_URL=postgresql://postgres:postgres_secure_pass@localhost:5440/erebus
HECATE_DATABASE_URL=postgresql://postgres:postgres_secure_pass@localhost:5441/agents
PLATFORM_DATABASE_URL=postgresql://postgres:postgres_secure_pass@localhost:5444/analytics
