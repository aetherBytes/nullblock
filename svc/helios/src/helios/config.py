...
class Config:
    ...
    def load_config(self) -> None:
        self.test = os.getenv("TEST", "NO ENV FILE LOADED")
        # self.api_key = os.getenv("API_KEY")
        # self.private_key = os.getenv("WALLET_PRIVATE_KEY")
        # self.custom_rpc_https = os.getenv(
        #     "custom_rpc_https", "https://api.mainnet-beta.solana.com/"
        # )
        # self.primary_mint = os.getenv(
        ...
        # self.computeUnitPriceMicroLamports = int(
        #     os.getenv("COMPUTE_UNIT_PRICE_MICRO_LAMPORTS") or 20 * 14000
        # )
