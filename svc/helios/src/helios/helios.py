import asyncio
import websockets
from solana_utils import setup_solana_client, get_transactions
from processing_utils import process_and_clean_data, serialize_data
import config


async def broadcast_data(websocket, data):
...
async def handler(websocket, path):
    ...
    while True:
        try:
            ...
            raw_data = get_transactions(client, config.WATCH_ADDRESS)

            # Process and clean data
            processed_data = process_and_clean_data(raw_data["result"])
