...
async fn handle_initialize(
    ...
    let result = InitializeResult {
        ...
        server_info: Implementation {
            ...
            title: Some("Hecate Vessel AI - NullBlock Agents".to_string()),
        },
        instructions: Some(
            "Hecate MCP server providing generic engram CRUD tools and user profile management. \
            Engrams are the universal memory primitive — same operations everywhere, \
            differentiated by tags, metadata, and content."
                .to_string(),
        ),
    };
