...
const DigitizingText: React.FC<DigitizingTextProps> = ({ 
  ...
  return (
    <div className={`${styles.digitizingText} ${styles[theme]} ${isComplete ? styles.complete : ''}`}>
      {displayText}
