...
const backgroundImage = "_backgroundImage_v8beg_60";
const bottomUIContainer = "_bottomUIContainer_v8beg_73";
const powerButtonContainer = "_powerButtonContainer_v8beg_86";
const powerButton = "_powerButton_v8beg_86";
const powerButtonImage = "_powerButtonImage_v8beg_107";
const splineObject = "_splineObject_v8beg_127";
const flickerGlow = "_flickerGlow_v8beg_1";
const moveGradient = "_moveGradient_v8beg_1";
const pulse = "_pulse_v8beg_1";
const typing = "_typing_v8beg_1";
const blinkCaret = "_blinkCaret_v8beg_1";
const backgroundFade = "_backgroundFade_v8beg_1";
const styles$1 = {
  backgroundImage,
  bottomUIContainer,
