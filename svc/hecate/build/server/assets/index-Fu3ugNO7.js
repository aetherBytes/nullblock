...
const echoButton$1 = "_echoButton_1kzce_1";
const styles$3 = {
...
const parentContainer = "_parentContainer_rybt3_53";
const sidebar = "_sidebar_rybt3_60";
const pulse = "_pulse_rybt3_1";
const mainScreenContent = "_mainScreenContent_rybt3_68";
const flickerGlow = "_flickerGlow_rybt3_1";
const moveGradient = "_moveGradient_rybt3_1";
const backgroundFade = "_backgroundFade_rybt3_1";
const echoScreen = "_echoScreen_rybt3_81";
const echoTitle = "_echoTitle_rybt3_92";
const echoContent = "_echoContent_rybt3_93";
const typing = "_typing_rybt3_1";
const blinkCaret = "_blinkCaret_rybt3_1";
const echoImage = "_echoImage_rybt3_100";
const echoImageSmall = "_echoImageSmall_rybt3_101";
const styles$2 = {
  parentContainer,
  sidebar,
  pulse,
...
const characterContainer = "_characterContainer_1nkcl_15";
const float = "_float_1nkcl_1";
const styles$1 = {
  characterContainer,
  float
};
const Moxi = () => /* @__PURE__ */ jsx("div", { className: styles$1.characterContainer, children: /* @__PURE__ */ jsx("img", { src: MoxiImage }) });
const backgroundImage = "_backgroundImage_7ii3u_1";
const buttonsContainer = "_buttonsContainer_7ii3u_10";
const echoButton = "_echoButton_7ii3u_20";
const styles = {
  backgroundImage,
  buttonsContainer,
  echoButton
};
const Home = () => /* @__PURE__ */ jsxs("div", { className: styles.backgroundImage, children: [
  /* @__PURE__ */ jsx(Moxi, {}),
  /* @__PURE__ */ jsx(Echo, {}),
