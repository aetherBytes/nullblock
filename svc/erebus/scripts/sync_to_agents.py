...
# Database URLs
EREBUS_URL = os.getenv('EREBUS_DATABASE_URL', 'postgresql://postgres:postgres_secure_pass@localhost:5440/erebus')
AGENTS_URL = os.getenv('AGENTS_DATABASE_URL', 'postgresql://postgres:postgres_secure_pass@localhost:5441/agents')
